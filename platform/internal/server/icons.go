...
// Inline SVG icon set (Lucide-style line icons). Server-rendered so the admin
// UI never ships emoji or a webfont — icons inherit `currentColor` and scale
// with font-size via the `.ic` class.
var iconPaths = map[string]string{
	...
	"layers":     `<path d="m12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.57-3.9a1 1 0 0 0 0-1.83z"/><path d="M2 12a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 12"/><path d="M2 17a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 17"/>`,
...
// icon returns an inline SVG element for the named icon. An optional extra CSS
// class can be supplied. Unknown names render nothing (no broken glyph).
func icon(name string, class ...string) template.HTML {
	...
	b.WriteString(cls)
	b.WriteString(`" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">`)
	b.WriteString(body)
	b.WriteString(`</svg>`)
